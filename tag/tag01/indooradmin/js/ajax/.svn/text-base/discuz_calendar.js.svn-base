/*
	...
	$RCSfile: discuz_calendar.js,v $
	$Revision: 1.1 $
	$Date: 2011/06/25 02:33:32 $
	
	
	usage:
	<input type="text" value="0000-00-00" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" onclick="showcalendar(event, this)" size="25" name="bday">
	--by iorichina
*/
...
function loadcalendar() {
	...
	s += '<tr align="center" class="header"><td class="header"><a href="###" onclick="refreshcalendar(yy, mm-1)" title="涓婁竴鏈�">銆�</a></td><td colspan="5" style="text-align: center" class="header"><a href="###" onclick="showdiv(\'year\');doane(event)" title="鐐瑰嚮閫夋嫨骞翠唤" id="year"></a>&nbsp; - &nbsp;<a id="month" title="鐐瑰嚮閫夋嫨鏈堜唤" href="###" onclick="showdiv(\'month\');doane(event)"></a></td><td class="header"><A href="###" onclick="refreshcalendar(yy, mm+1)" title="涓嬩竴鏈�">銆�</A></td></tr>';
	s += '<tr class="category calendar_header"><td>鏃�</td><td>涓€</td><td>浜�</td><td>涓�</td><td>鍥�</td><td>浜�</td><td>鍏�</td></tr>';
	for(var i = 0; i < 6; i++) {
		s += '<tr class="altbg2">';
		for(var j = 1; j <= 7; j++)
	...
	s += '<tr id="hourminute"><td colspan="7" align="center"><input type="text" size="1" value="" id="hour" onKeyUp=\'this.value=this.value > 23 ? 23 : zerofill(this.value);controlid.value=controlid.value.replace(/\\d+(\:\\d+)/ig, this.value+"$1")\'> 鐐� <input type="text" size="1" value="" id="minute" onKeyUp=\'this.value=this.value > 59 ? 59 : zerofill(this.value);controlid.value=controlid.value.replace(/(\\d+\:)\\d+/ig, "$1"+this.value)\'> 鍒�</td></tr>';
	s += '</table></div></div>';
