...
public class ServiceClientInterface {
	...
	/**
	 * the base URL which your are request to
	 */
	public static String url = "http://192.168.2.50:8080/indooradmin/api.php?r=";
	/**
	 ...
	 */
	public static boolean requestMethodIsGet = true;
	...
	public static String post(int actionID, String[] params) throws Exception {
		...
		jsonArrayObj = (jsonArrayObj == null) ? "" : URLEncoder
				.encode(jsonArrayObj);
		String requestUrl = url + getServiceClientAction(actionID);
		String responseJsonStr = HttpService.post(requestUrl, cookie,
				jsonArrayObj);
	...
	public static String get(int actionID, String[] params) throws Exception {
		...
		jsonArrayObj = (jsonArrayObj == null) ? "" : URLEncoder
				.encode(jsonArrayObj);
		String requestUrl = url + getServiceClientAction(actionID)
				+ "&jsonArrayObj=" + jsonArrayObj;
		String responseJsonStr = HttpService.get(requestUrl, cookie);
		return (handleResponse(responseJsonStr));
	}
