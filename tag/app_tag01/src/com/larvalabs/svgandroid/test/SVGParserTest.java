...
/**
 * Makes use of test svg images from
 * http://www.w3.org/Graphics/SVG/Test/20061213
 * /archives/W3C_SVG_11_BasicTestSuite.tar.gz to verify parser is functioning
 * properly.
 */
public class SVGParserTest extends AndroidTestCase {
	...
	public void testShapes() throws Exception {
		...
		SVGTestPair pair = new SVGTestPair(assets.open("png/shapes.png"), svg,
				"shapes");
		...
		// Verify that the two images don't differ too much overall, sanity
		// check
	...
	public void testStrokes() throws Exception {
		...
		SVGTestPair pair = new SVGTestPair(assets.open("png/strokes.png"), svg,
				"strokes");
	...
	public void testTransformations() throws Exception {
		...
		SVGTestPair pair = new SVGTestPair(
				assets.open("png/transformations.png"), svg, "transformations");
	...
	public void testGradients() throws Exception {
		...
		SVGTestPair pair = new SVGTestPair(assets.open("png/gradients.png"),
				svg, "gradients");
