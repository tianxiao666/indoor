...
{ 
	...
	function bilateral( $uid, $page = 1, $count = 50, $sort = 0 )
	{
		...
		$params['page'] = $page;
		$params['sort'] = $sort;
		return $this->oauth->get( 'https://api.weibo.com/2/friendships/friends/bilateral.json', $params  );
	}
	...
	function bilateral_ids( $uid, $page = 1, $count = 50, $sort = 0)
	{
		...
		$params['page'] = $page;
		$params['sort'] = $sort;
		return $this->oauth->get( 'https://api.weibo.com/2/friendships/friends/bilateral/ids',  $params  );
	}
