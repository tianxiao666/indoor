	...
	<div class="content">
		...
		<div class="main">
			<div class="part3">
				...
				<div class="cont1">
				<form  id="mainForm" action="{$phpSelf}?r=<?php echo $controllerId ?>/create" style="margin:0px;padding:0px;" method="POST">
					<div class="left">
							<?php foreach($columns as $column): ?>
							
							<div class="a01"><?php echo $column; ?></div>
							<div class="a02"><input name="<?php echo $modelClass; ?>[<?php echo $column; ?>]" id="<?php echo $column; ?>" type="text" style="width:290px;" /></div>
							<?php endforeach; ?>
  ...
  <tr>
    ...
    <td><a href="#!">编辑</a></td>
					...
					*}
					...
					<div class="cont6">
						<span class="button"><a href="javascript:void($('#mainForm').submit())">&nbsp;&nbsp;&nbsp;添加&nbsp;&nbsp;&nbsp;</a></span>
