...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="mainFrameTopline">
    <tr>
        <td width="200" align="left" class="nameChannel">&#187; 新增<?php echo $modelClass; ?></td>
        <td align="right">
...
<form action="{$phpSelf}?r=<?php echo $controllerId ?>/create" method="POST" id="<?php echo $modelClass; ?>">
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="mainFrame">
    <tr>
        <td align="left" style="padding:20px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="50%" align="left" class="nameFunction"><img src="images/icon/m_articles.gif" border="0" align="absmiddle" /> 新增<?php echo $modelClass; ?></td>
					<td width="50%" align="right">&nbsp;</td>
				</tr>
			</table>
		    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="datalist">
	    		<?php foreach($columns as $column): ?>
	    		<tr><td><?php echo $column; ?>:</td><td><input type="text" name="<?php echo $modelClass; ?>[<?php echo $column; ?>]" id="<?php echo $column; ?>"></td></tr>
				<?php endforeach; ?>
	    		<tr>
	    			<td align="center" colspan="2">
	    				<input type="submit" value="添加" >
	    				<input type="button" value="返回" onclick="history.go(-1);" name="goback">
	    			</td>
	    		</tr>
            </table>
		</td>
