 ...
 * @version $Id: HelpCommand.php,v 1.1 2010/03/16 08:05:37 liujz Exp $
 */

/**
 * HelpCommand displays help information for commands under SFc shell.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: HelpCommand.php,v 1.1 2010/03/16 08:05:37 liujz Exp $
...
by the 'SFC_SHELL_COMMAND_PATH' environment variable. The command class
