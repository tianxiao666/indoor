 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CConfiguration.php,v 1.1.1.1 2009/05/13 06:26:42 haka Exp $
...
class CConfiguration extends CMap
{
	 ...
	 * Please use {@link YiiBase::createComponent SF::createComponent}, instead.
	 *
	...
	public static function createObject($config)
	{
		...
		return SF::createComponent($config);
	}
}
