 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CList.php,v 1.1.1.1 2009/05/13 06:26:42 haka Exp $
...
class CList extends CComponent implements IteratorAggregate,ArrayAccess,Countable
{
	...
	public function itemAt($index)
	{
		if(isset($this->_d[$index]))
			...
			throw new CException(SF::t('SF','List index "{index}" is out of bound.',
				array('{index}'=>$index)));
	}
	...
	public function insertAt($index,$item)
	{
		if(!$this->_r)
		{
			...
			throw new CException(SF::t('SF','The list is read only.'));
	}
	...
	public function copyFrom($data)
	{
		if(is_array($data) || ($data instanceof Traversable))
		{
			...
			throw new CException(SF::t('SF','List data must be an array or an object implementing Traversable.'));
	}
