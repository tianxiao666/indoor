 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CStack.php,v 1.1.1.1 2009/05/13 06:26:42 haka Exp $
...
class CStack extends CComponent implements IteratorAggregate,Countable
{
	...
	public function copyFrom($data)
	{
		if(is_array($data) || ($data instanceof Traversable))
		{
			...
			throw new CException(SF::t('SF','Stack data must be an array or an object implementing Traversable.'));
	}
	...
	public function peek()
	{
		if($this->_c)
			...
			throw new CException(SF::t('SF','The stack is empty.'));
	}
