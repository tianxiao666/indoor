 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CMap.php,v 1.2 2010/03/31 08:34:15 liujz Exp $
...
class CMap extends CComponent implements IteratorAggregate,ArrayAccess,Countable
{
	...
	public function add($key,$value)
	{
		if(!$this->_r)
		{
			...
			throw new CException(SF::t('SF','The map is read only.'));
	}
	...
	public function copyFrom($data)
	{
		if(is_array($data) || $data instanceof Traversable)
		{
			...
			throw new CException(SF::t('SF','Map data must be an array or an object implementing Traversable.'));
	}
