 ...
 * @copyright Copyright &copy; 2008-2009  Software LLC
 * @license http://www.yiiframework.com/license/
 */

require_once(SF::getPathOfAlias('system.vendors.markdown.markdown').'.php');
 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CMarkdownParser.php,v 1.2 2010/03/31 08:32:38 liujz Exp $
...
class CMarkdownParser extends MarkdownExtra_Parser
{
	...
	{
		return SF::getPathOfAlias('system.vendors.TextHighlighter.highlight').'.css';
	}
	...
	protected function createHighLighter($options)
	{
		...
		{
			require_once(SF::getPathOfAlias('system.vendors.TextHighlighter.Text.Highlighter').'.php');
			require_once(SF::getPathOfAlias('system.vendors.TextHighlighter.Text.Highlighter.Renderer.Html').'.php');
		}
