 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CPropertyValue.php,v 1.2 2010/03/31 08:32:38 liujz Exp $
...
class CPropertyValue
{
	...
	public static function ensureEnum($value,$enumType)
	{
		...
		if($types[$enumType]->hasConstant($value))
			...
			throw new CException(SF::t('SF','Invalid enumerable value "{value}". Please make sure it is among ({enum}).',
