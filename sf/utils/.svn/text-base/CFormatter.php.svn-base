 ...
 * Therefore, one may call <code>SF::app()->format->boolean(1)</code>.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CFormatter.php,v 1.1 2010/03/31 08:35:24 liujz Exp $
...
class CFormatter extends CApplicationComponent
{
	...
	public function format($value,$type)
	{
		...
		if(method_exists($this,$method))
			...
			throw new CException(SF::t('SF','Unknown type "{type}".',array('{type}'=>$type)));
	}
