 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CBooleanValidator.php,v 1.1 2010/03/31 08:35:24 liujz Exp $
...
class CBooleanValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		{
			$message=$this->message!==null?$this->message:SF::t('SF','{attribute} must be either {true} or {false}.',
