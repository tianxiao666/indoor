 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CFilterValidator.php,v 1.2 2010/03/31 08:32:39 liujz Exp $
...
class CFilterValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		if($this->filter===null || !is_callable($this->filter))
			throw new CException(SF::t('SF','The "filter" property must be specified with a valid callback.'));
