 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CEmailValidator.php,v 1.2 2010/03/31 08:32:39 liujz Exp $
...
class CEmailValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if(!$valid)
		{
			$message=$this->message!==null?$this->message:SF::t('SF','{attribute} is not a valid email address.');
