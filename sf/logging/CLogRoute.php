 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CLogRoute.php,v 1.3 2010/05/13 02:18:05 liujz Exp $
...
abstract class CLogRoute extends CComponent
{
	 ...
	 * The value of this property will be passed to {@link SF::createComponent} to create
	 ...
	 */
	public function collectLogs($logger, $processLogs=true)
	{
		...
		{
			if($this->filter!==null)
				SF::createComponent($this->filter)->filter($this->logs);
