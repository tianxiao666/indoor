 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CFormModel.php,v 1.1 2009/05/13 06:31:11 haka Exp $
 * @package system.web
 * @since 1.0
 */
class CFormModel extends CDataModel
{
	private $_validators;
	 ...
	 * As of version 1.0.4, this parameter will be used to set the {@link CDataModel::scenario scenario}
	 ...
	 * See {@link CDataModel::safeAttributes} for more details about how to
	 * override this method.
	 * @return array list of safe attribute names.
	 * @see CDataModel::safeAttributes
	 * @since 1.0.2
	 */
	...
	/**
	 * @return array list of validators created according to {@link CDataModel::rules rules}.
	 */
